...
public class RackandPinionCommandIn extends CommandBase{
    ...
    public RackandPinionCommandIn(RackandPinionSubsystem rackandPinionSubsystem, double target_position_m)
    {
    ...
    public boolean isFinished(){
        if(m_rackandPinionSubsystem.rack_and_pinion.getSelectedSensorPosition() < 4000) return true;
        return false; 
    }
